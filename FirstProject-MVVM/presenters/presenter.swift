...
class ProductsPresenter {
    ...
    func presentData(dict : [String : [String : Any]], allPoints : [Point]){
        ...
        self.delegate?.presentProducts(array: res , allPoints: allPoints)
    }
}
...
//            let productName = value["name"] as! String
//            let price = value["price"] as! Int
//            let destinationPage = UIHostingController(rootView: Page(images: uiImages, mainImg: uiImages[0], productName: productName, description: value["description"] as! String, price: price))
//            let shortdescription = value["description"] as! String
